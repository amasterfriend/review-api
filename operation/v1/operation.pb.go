...
const file_api_operation_v1_operation_proto_rawDesc = "" +
	...
	"\x06status\x18\x02 \x01(\x05R\x06status2\x89\x02\n" +
	"\tOperation\x12}\n" +
	...
	"\vAuditAppeal\x12$.api.operation.v1.AuditAppealRequest\x1a\".api.operation.v1.AuditAppealReply\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19operation/v1/appeal/auditB3\n" +
