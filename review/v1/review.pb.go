...
const file_api_review_v1_review_proto_rawDesc = "" +
	...
	"\x04page\x18\x02 \x01(\x05B\a\xfaB\x04\x1a\x02 \x00R\x04page\x12\x1d\n" +
	"\x04size\x18\x03 \x01(\x05B\t\xfaB\x06\x1a\x04\x10d \x00R\x04size\"I\n" +
	...
	"\bappealID\x18\x01 \x01(\x03R\bappealID\"\xb6\x01\n" +
	...
	"\bappealID\x18\x01 \x01(\x03R\bappealID2\xc0\a\n" +
	"\x06Review\x12k\n" +
	"\fCreateReview\x12\".api.review.v1.CreateReviewRequest\x1a .api.review.v1.CreateReviewReply\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*\"\n" +
	"/v1/review\x12j\n" +
	"\tGetReview\x12\x1f.api.review.v1.GetReviewRequest\x1a\x1d.api.review.v1.GetReviewReply\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/v1/review/{reviewID}\x12\x88\x01\n" +
	"\x12ListReviewByUserID\x12(.api.review.v1.ListReviewByUserIDRequest\x1a&.api.review.v1.ListReviewByUserIDReply\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/v1/review/user/{userID}\x12\x8d\x01\n" +
	"\x13ListReviewByStoreID\x12).api.review.v1.ListReviewByStoreIDRequest\x1a'.api.review.v1.ListReviewByStoreIDReply\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/v1/review/store/{storeID}\x12n\n" +
...
var file_api_review_v1_review_proto_goTypes = []any{
	...
	(*ListReviewByStoreIDRequest)(nil), // 6: api.review.v1.ListReviewByStoreIDRequest
	(*ListReviewByStoreIDReply)(nil),   // 7: api.review.v1.ListReviewByStoreIDReply
...
var file_api_review_v1_review_proto_depIdxs = []int32{
	...
	4,  // 5: api.review.v1.Review.ListReviewByUserID:input_type -> api.review.v1.ListReviewByUserIDRequest
	6,  // 6: api.review.v1.Review.ListReviewByStoreID:input_type -> api.review.v1.ListReviewByStoreIDRequest
	9,  // 7: api.review.v1.Review.ReplyReview:input_type -> api.review.v1.ReplyReviewRequest
	...
	5,  // 13: api.review.v1.Review.ListReviewByUserID:output_type -> api.review.v1.ListReviewByUserIDReply
	7,  // 14: api.review.v1.Review.ListReviewByStoreID:output_type -> api.review.v1.ListReviewByStoreIDReply
	10, // 15: api.review.v1.Review.ReplyReview:output_type -> api.review.v1.ReplyReviewReply
